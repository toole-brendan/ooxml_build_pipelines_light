...
NOT part of the build pipeline. The pipeline (workbook_sea_range_telemetry/) is
...
# Built workbook lands at the project root (projects/sea_range_telemetry/), one level up from here.
OUT = Path(__file__).resolve().parent.parent / "20260607_Sea Range Telemetry_vS.xlsx"
