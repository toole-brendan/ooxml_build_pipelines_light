...
DECK_DIR = Path(__file__).resolve().parents[1]      # .../archetypes/schematics/
ROOT = Path(__file__).resolve().parents[5]          # workspace root (holds deck_core/ + infra/)

OUT = DECK_DIR / "Schematics (reference port).pptx"
...
_TITLE = "Schematics (reference port)"
_CREATOR = "schematics build_deck.py"
_APP = "schematics"
