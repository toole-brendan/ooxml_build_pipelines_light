...
from deck_core.primitives import (
    slide, table, trow, tcell, tcell_rich, tpara, trun, tbreak, breadcrumb, title_placeholder, prelim_chip,
)
...
def edge(color, w=12700):
    """One cell-border edge (default 1pt hairline; the gridlines here are 6350)."""
...
def rcell(paras, *, fill=None, anchor="ctr", span=1, rowspan=1, **edges):
    """tcell_rich with span/anchor defaulted to the engine defaults; borders via L/R/T/B=edge(...)."""
