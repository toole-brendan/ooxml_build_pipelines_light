...
two dirs on sys.path:
  - the build dir (this package's parent, ``projects/other/awards_methodology/``) so
...
_PROJECT_ROOT = str(_HERE.parents[1])   # projects/other/awards_methodology/   (holds deck_awards_methodology + build_deck.py)
