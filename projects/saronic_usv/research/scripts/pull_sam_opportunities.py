...
Run:
    cd /Users/brendantoole/projects3/ooxml_build_pipelines_light/projects/saronic_usv/research
...
OUT_DIR = REPO_ROOT / "projects" / "saronic_usv" / "research" / "sam_opportunities"
