...
Scaffold status: seeded with a single placeholder page (overview) so the pipeline
builds a valid .docx on first run. Replace it with real page modules.

To add a page:
  1. Copy docx_core/doc_base_template.py to doc_army/pages/<name>.py.
...
PAGES = [
    overview,  # placeholder page (replace)
]
