...
both keyed off the Recompete Radar As-of cell (_tabs.AS_OF_CELL) - so the leaf
...
PIPELINE_EVENTS, pipeline_cols = make_flat_sheet(
    ...
    intro="Army + USACE watercraft SAM Opportunities notices (trailing ~12 months), "
          "sorted soonest-deadline first. Open? and Days to deadline are LIVE vs the "
          "Recompete Radar As-of date; raw fields are faithful to the SAM pull.",
