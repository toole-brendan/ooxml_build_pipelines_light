...
sys.path.insert(0, str(REPO / "projects/distributed_shipbuilding/research/scripts"))
from _corpus import iter_records  # noqa: E402

NAICS_REF = REPO / "projects/research_shared/submarine_subaward_code_package/vendor_naics_reference.csv"
SAM_ENRICH = REPO / "projects/research_shared/sam_entity_enrichment/unique_uei_sam_enrichment.csv"
REFACTOR = REPO / "projects/research_shared/workbook_award_classification_refactor"
