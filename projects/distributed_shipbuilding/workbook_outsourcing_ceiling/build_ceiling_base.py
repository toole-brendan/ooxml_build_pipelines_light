...
# .../distributed_shipbuilding/workbook_outsourcing_ceiling -> .../distributed_shipbuilding
_DSB = os.path.abspath(os.path.join(_HERE, ".."))
EXTRACTED = os.path.join(_HERE, "extracted")

SUBS_CSV = os.path.join(_DSB, "submarines", "workbook", "extracted",
                        "cost_funnel_with_subawards.csv")
DDG_CSV = os.path.join(_DSB, "ddg", "workbook", "extracted",
