...
NOT part of the build pipeline. The pipeline (workbook_award_analysis/) is strictly
...
OUT = Path(__file__).resolve().parent.parent / "20260612_Distributed Shipbuilding Award Analysis_vS.xlsx"
