...
``projects/distributed_shipbuilding/research_shared/award_classification_refactor.xlsx`` through the shared
...
dirs on sys.path:
  - the build dir (this package's parent,
    ``projects/distributed_shipbuilding/research_shared/workbook_award_classification_refactor/``) so
...
_PROJECT_ROOT = str(_HERE.parents[1])   # projects/distributed_shipbuilding/research_shared/workbook_award_classification_refactor/
