...
WORKBOOK_DIR = Path(__file__).resolve().parents[1]   # projects/distributed_shipbuilding/research_shared/workbook_award_classification_refactor/
PROJECT_DIR = Path(__file__).resolve().parents[2]    # projects/distributed_shipbuilding/research_shared/   (build output lands here)
