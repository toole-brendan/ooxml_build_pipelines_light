...
VIRGINIA_SUBAWARD_TX, virginia_tx_cols = make_flat_sheet(
    ...
    intro="The raw Virginia-class subaward pull, CY2016-2025 - one row per deduped FSRS published report; nominal dollars, with MIB/BlueForge UEIs already removed upstream.",
    widths=_WIDTHS,
