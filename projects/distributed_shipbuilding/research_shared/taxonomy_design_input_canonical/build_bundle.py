...
OLD  = REPO / "projects/distributed_shipbuilding/research_shared/taxonomy_design_input"          # untouched source for HII/SWBS
ENR  = REPO / "projects/distributed_shipbuilding/research_shared/sam_entity_enrichment"
OUT  = REPO / "projects/distributed_shipbuilding/research_shared/taxonomy_design_input_canonical"
OUT.mkdir(parents=True, exist_ok=True)

def _load_corpus():
    spec = importlib.util.spec_from_file_location(
        "_corpus", REPO / "projects/distributed_shipbuilding/research_shared/corpus/scripts/_corpus.py")
