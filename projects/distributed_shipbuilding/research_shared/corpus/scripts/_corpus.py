...
REGISTRY_CSV = REPO / "projects/distributed_shipbuilding/research_shared/supplier_bucketing/vendor_evidence_registry.csv"
EXTRACTED = REPO / "projects/distributed_shipbuilding/research_shared/corpus/extracted"
