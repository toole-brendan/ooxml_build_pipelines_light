...
NOT part of the build pipeline. The pipeline (workbook_consolidated/) is strictly
...
OUT = Path(__file__).resolve().parent.parent / "20260605_Distributed Shipbuilding Consolidated_vS.xlsx"
