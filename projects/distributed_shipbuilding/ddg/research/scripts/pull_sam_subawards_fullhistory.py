...
Run:
    cd /Users/brendantoole/projects3/ooxml_build_pipelines_light/projects/distributed_shipbuilding/ddg/research
...
PROJECT_ROOT = os.path.join(REPO_ROOT, "projects", "distributed_shipbuilding", "ddg", "research")
