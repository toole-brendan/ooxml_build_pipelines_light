...
TAXONOMY_PY = REPO / "projects/distributed_shipbuilding/workbook/workbook_consolidated/sheets/_taxonomy.py"
REGISTRY_CSV = REPO / "projects/research_shared/supplier_bucketing/vendor_evidence_registry.csv"
EXTRACTED = REPO / "projects/distributed_shipbuilding/research/extracted"

PROGRAMS = {
    "submarines": {
        "fullhistory": REPO / "projects/distributed_shipbuilding/submarines/research/sam_subawards_fullhistory",
        "scope_json": REPO / "projects/distributed_shipbuilding/submarines/workbook/extracted/nc_scope_summary.json",
        "naics_csv": REPO / "projects/distributed_shipbuilding/submarines/research/extracted/entity_naics_lookup.csv",
        "groups": None,                      # all in-scope PIIDs (GDEB shipbuilder-directed)
    },
    "ddg": {
        "fullhistory": REPO / "projects/distributed_shipbuilding/ddg/research/sam_subawards_fullhistory",
        "scope_json": REPO / "projects/distributed_shipbuilding/ddg/workbook/extracted/nc_scope_summary.json",
        "naics_csv": REPO / "projects/distributed_shipbuilding/ddg/research/extracted/entity_naics_lookup.csv",
