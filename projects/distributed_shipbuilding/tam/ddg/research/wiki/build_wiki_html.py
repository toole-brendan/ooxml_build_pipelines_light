"""Build the Outsourced DDG-51 destroyer work single-page article.

Adapted from the submarine wiki generator. INDEX.md supplies the lead,
...
ARTICLES: list[tuple[str, str, str]] = [
    ("01-scope-and-funnel-framework.md", "Framing the funnel", "Scope and the funnel framework"),
    ("02-total-ship-cost-and-production.md", "Framing the funnel", "Total ship cost and the DDG-51 production line"),
    ("03-plans-gfe-and-other-layers.md", "Framing the funnel", "Plans, GFE, and other layers"),
    ("04-dod-contract-announcement-data.md", "Direct measurement", "DoD contract announcement data"),
    ("05-ffata-visible-subawards.md", "Direct measurement", "FFATA-visible first-tier subawards"),
    ("06-vendors-and-concentration.md", "Direct measurement", "Vendors and concentration"),
    ("07-gd-bath-iron-works.md", "The two yards", "GD Bath Iron Works"),
    ("08-hii-ingalls-shipbuilding.md", "The two yards", "HII Ingalls Shipbuilding"),
    ("09-yard-side-outsourcing-hidden.md", "The two yards", "Yard-side outsourcing — the hidden $1.8B/yr"),
    ("10-aegis-and-spy6.md", "Government-furnished equipment", "Aegis Combat System and AN/SPY-6 radar"),
    ("11-other-gfe.md", "Government-furnished equipment", "Other GFE — Mk 41 VLS, Mk 45 gun, LM2500, SEWIP, CIWS"),
    ("12-myp-redaction-and-unseen-layer.md", "Beyond visible", "The MYP redaction and the unseen layer"),
...
<title>Outsourced work on U.S. Arleigh Burke-class destroyer construction</title>
