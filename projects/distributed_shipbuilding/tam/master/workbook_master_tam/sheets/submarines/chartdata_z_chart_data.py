...
from workbook_master_tam.sheets.submarines.data_entity_master import ent_row_cell, top_supplier_indices
from workbook_master_tam.sheets.submarines.validation_sib_excluded import sib_entity_dollar_cell
