"""Submarine sub-package data binding.

Points EXTRACTED / load_extracted_csv at this program's namespaced slice of the
master extracted root. The relocated submarine sheet modules import these three
names (formerly from ``workbook_submarines.lib``).
"""
...
EXTRACTED = _ROOT / "submarines"


def load_extracted_csv(name: str):
    """Load extracted/submarines/<name>.csv."""
