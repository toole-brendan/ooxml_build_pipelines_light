"""_layout - a local row cursor for the submarine sheet modules.
...
workbook_submarines so the shared engine stays untouched; it just composes the
...
with_gutter=True, matching every submarine sheet.
"""
