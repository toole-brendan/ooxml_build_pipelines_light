...
from workbook_master_tam.sheets.scn_budget import scn_cell
...
def _make():
    ...
    r_va = c.write(["Virginia OBBBA BC share (Sec. 20002(16))",
                    f"={scn_cell(2013, 2026, 'bc_pct')}", 0, lambda r: f"=C{r}+D{r}"],
                   styles=[S_DEFAULT, S_LINK_PCT, S_PCT_INPUT_FILL, S_PCT])
    P["obbba_share"] = {2013: ("E", r_va)}
