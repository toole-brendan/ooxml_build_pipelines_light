...
from workbook_master_tam.sheets.ddg.data_obbba_funding import obbba_gross_cell, obbba_bc_base_cell
...
from workbook_master_tam.sheets.ddg.data_ap_bridge import cy_ap_inwindow_cell, ap_tam_cell
from workbook_master_tam.sheets.ddg.validation_number_audit import fail_count_formula, fail_count_cell as _fig_fail_cell
from workbook_master_tam.sheets.ddg._layout import RowCursor

_GROUP = "validation"
_TAB = "DDG QA Reconciliation"
_NCOLS = 6
_Q = '"'
_QA_STATUS_ROW = 7
_QA_FAIL_ROW = 8
