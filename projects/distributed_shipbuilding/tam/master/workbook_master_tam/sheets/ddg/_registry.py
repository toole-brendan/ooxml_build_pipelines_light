...
Role vocabulary is normalized to the DDG codebase: registry `gfe` -> `gfe_mib`;
...
from workbook_master_tam.sheets.ddg._bind import REGISTRY_CSV
...
_ROLE_MAP = {"gfe": "gfe_mib", "residual": "supplier"}
