...
from workbook_master_tam.sheets._italic import S_ITALIC
from workbook_master_tam.sheets._tabs import TAB_EXEC_SUMMARY
from workbook_master_tam.sheets import _periods
...
_PROGRAMS = [("Virginia", VA), ("Columbia", CO), ("DDG-51", DD)]
...
def _render() -> WorksheetSpec:
    ...
    c.caption("Portfolio outsourced TAM, FY2022-31, constant FY2026 $M")  # row 3
    c.blank(2)

    # §1 Scope
    c.section("§1 - Scope", _NCOLS_2)
    c.blank()
    c.write(["Question", "Portfolio outsourced new-construction TAM"],
