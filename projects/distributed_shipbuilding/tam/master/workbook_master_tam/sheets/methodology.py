...
def _render() -> WorksheetSpec:
    ...
    c.blank()
    _kv(c, "Question", "Supplier-addressable TAM for Virginia, Columbia, and DDG-51 new construction.")
    ...
    c.blank()
    _kv(c, "Virginia (~34%)", "$-weighted Block V master (33% + 1%) + disclosed announcements; master dominates.")
    _kv(c, "Columbia (~22%)", "Build I construction master (other-US 22% + foreign 0%).")
    ...
    for src, use in [
        ...
        ("Virginia Block V / Columbia Build I", "submarine applied BC coefficients"),
