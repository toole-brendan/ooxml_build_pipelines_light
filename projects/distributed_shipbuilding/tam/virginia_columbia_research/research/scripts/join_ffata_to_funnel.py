...
# .../projects/distributed_shipbuilding/tam/virginia_columbia_research/research/scripts -> .../ooxml_build_pipelines_light
_REPO = os.path.abspath(os.path.join(_HERE, "..", "..", "..", "..", "..", ".."))
EXTRACTED = os.path.join(_REPO, "projects", "distributed_shipbuilding", "tam", "virginia_columbia_research", "extracted")
