...
Resume-safe (skips cached). Uses --compressed flag to handle gzip responses.
"""
import os
import subprocess
import sys
...
CACHE = Path("/Users/brendantoole/projects2/submarine_outsourced_work/research_primary_sources/dod_announcement_pop/cache_wayback")
