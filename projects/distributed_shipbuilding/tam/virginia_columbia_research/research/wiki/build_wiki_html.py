"""Build the Outsourced submarine work single-page article.

Adapts the Wikipedia-style wiki generator (originally wiki_v6 maritime range
instrumentation, then DDG-51 construction) to the submarine outsourcing wiki.

INDEX.md supplies the lead, infobox, see-also, references, further reading,
and external links. Each numbered file in this directory becomes one H2
section.
...
ARTICLES: list[tuple[str, str, str]] = [
    ("01-scope-and-funnel-framework.md", "The cost funnel", "Scope and the funnel framework"),
    ("02-total-ship-cost.md", "The cost funnel", "Total ship cost"),
    ("03-plans-gfe-and-other-layers.md", "The cost funnel", "Plans, GFE, and other layers"),
    ("04-basic-construction.md", "The cost funnel", "Basic Construction"),
    ("05-long-lead-and-advance-procurement.md", "The cost funnel", "Long-lead and advance procurement"),
    ("06-outsourced-band-within-bc.md", "The cost funnel", "The outsourced layer within Basic Construction"),
    ("07-dod-contract-announcement-data.md", "Direct measurement", "DoD contract announcement data"),
    ("08-ffata-visible-subawards.md", "Direct measurement", "FFATA-visible first-tier subawards"),
    ("09-vendors-and-concentration.md", "Direct measurement", "Vendors and concentration"),
    ("10-maritime-industrial-base.md", "Direct measurement", "The Maritime Industrial Base layer"),
    ("11-hii-newport-news-gap.md", "Beyond visible", "The HII Newport News visibility gap"),
    ("12-unseen-layer.md", "Beyond visible", "The unseen layer"),
    ("13-executive-commentary.md", "Direction", "Executive commentary"),
    ("14-navy-osd-policy.md", "Direction", "Navy and OSD industrial-base policy"),
    ("15-prime-financials.md", "Direction", "Prime financials"),
    ("16-data-sources-pipeline-limitations.md", "Methodology", "Data sources, pipeline, and limitations"),
]
...
<title>Outsourced work on U.S. nuclear submarine construction</title>
