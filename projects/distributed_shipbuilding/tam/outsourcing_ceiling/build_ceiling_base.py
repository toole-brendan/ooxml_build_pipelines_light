...
# .../distributed_shipbuilding/tam/outsourcing_ceiling -> .../distributed_shipbuilding/tam
_DSB = os.path.abspath(os.path.join(_HERE, ".."))
EXTRACTED = os.path.join(_HERE, "extracted")

SUBS_CSV = os.path.join(_DSB, "submarines", "extracted",
                        "cost_funnel_with_subawards.csv")
DDG_CSV = os.path.join(_DSB, "ddg", "extracted",
