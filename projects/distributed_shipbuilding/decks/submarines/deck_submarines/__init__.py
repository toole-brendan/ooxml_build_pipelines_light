"""deck_submarines - Distributed Shipbuilding Submarines PowerPoint build pipeline.
...
_PROJECT_ROOT = str(_HERE.parents[1])   # projects/distributed_shipbuilding/submarines/deck/   (holds deck_submarines + build_deck.py)
