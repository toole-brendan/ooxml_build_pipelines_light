...
To add a page:
  1. Copy docx_core/doc_base_template.py to doc_distributed_shipbuilding/pages/<name>.py.
...
# Slide-mock pages (lane_evidence, priority_board) are unregistered - left on
# disk but out of the document. Re-add to PAGES to bring them back.
from . import sourcing_openings_explainer

PAGES = [
    sourcing_openings_explainer,  # Sourcing-openings methodology: plain-language prose explainer (portrait)
]
