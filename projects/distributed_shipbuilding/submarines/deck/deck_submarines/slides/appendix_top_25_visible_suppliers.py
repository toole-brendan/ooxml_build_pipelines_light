"""top_25_visible_suppliers - extended FFATA-visible supplier ledger (ranks 1-25) framed as a named-vendor floor."""
...
_SECTION = "Appendix"
_TOPIC = "Top 25 Visible Suppliers"
_TAKEAWAY = "Extended FFATA-visible list is a named-vendor floor"
...
def _evidence_chip(sp_id, x, y, w, value, qualifier):
    return text_box(sp_id, "EvidenceChip", x, y, w, 380_000,
        [_txt(value, size=VALUE_14PT, bold=True, color=BLACK, align="ctr"),
         _txt(qualifier, size=FINEPRINT_8_5PT, color=BLACK, align="ctr")],
