...
OLD  = REPO / "projects/distributed_shipbuilding/sam/sam_awards_data/taxonomy_design_input"          # untouched source for HII/SWBS
ENR  = REPO / "projects/distributed_shipbuilding/sam/sam_awards_data/sam_entity_enrichment"
OUT  = REPO / "projects/distributed_shipbuilding/sam/sam_awards_data/taxonomy_design_input_canonical"
OUT.mkdir(parents=True, exist_ok=True)

def _load_corpus():
    spec = importlib.util.spec_from_file_location(
        "_corpus", REPO / "projects/distributed_shipbuilding/sam/sam_awards_data/corpus/scripts/_corpus.py")
