...
def _make_subaward_activity() -> tuple[SheetEntry, dict]:
    ...
    rr += 1                     # intro (single tight line)
    rr += 2                     # blank(2)
    type_banner = rr; rr += 1
    rr += 1                     # blank under §1 banner
    type_header = rr; rr += 1
    ...
    def render() -> WorksheetSpec:
        ...
        c.write(_TYPE_HEADERS, styles=header_styles(_TYPE_HEADERS), start_col=2)
        ...
        c.write(_MTX_HEADERS, styles=header_styles(_MTX_HEADERS), start_col=2)
        ...
        c.write(_ROLL_HEADERS, styles=header_styles(_ROLL_HEADERS))
        for v in roll_rows:
            c.write([
                v[ri["Subawardee UEI"]],
        ...
        c.write(_ENG_HEADERS, styles=header_styles(_ENG_HEADERS))
        for a in act_rows:
        ...
        c.write(_BLK_HEADERS, styles=header_styles(_BLK_HEADERS), start_col=2)
