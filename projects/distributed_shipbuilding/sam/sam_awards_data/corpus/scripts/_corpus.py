...
REPO = Path(__file__).resolve().parents[6]  # sam_awards_data/corpus/scripts/_corpus.py -> repo root
TAXONOMY_PY = REPO / "projects/distributed_shipbuilding/tam/consolidated/workbook_consolidated/sheets/_taxonomy.py"
REGISTRY_CSV = REPO / "projects/distributed_shipbuilding/sam/sam_awards_data/supplier_bucketing/vendor_evidence_registry.csv"
EXTRACTED = REPO / "projects/distributed_shipbuilding/sam/sam_awards_data/corpus/extracted"
...
SCOPE_MANIFEST = REPO / ("projects/distributed_shipbuilding/sam/sam_awards_data/"
