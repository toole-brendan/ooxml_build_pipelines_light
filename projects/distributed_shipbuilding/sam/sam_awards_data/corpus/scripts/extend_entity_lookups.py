...
CACHE_DIRS = {
    "submarines": REPO / "projects/distributed_shipbuilding/tam/submarines/research/sam_entity_lookups",
    "ddg": REPO / "projects/distributed_shipbuilding/tam/ddg/research/sam_entity_lookups",
}
