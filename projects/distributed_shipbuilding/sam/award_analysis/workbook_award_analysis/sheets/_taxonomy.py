...
COPY-FROM projects/distributed_shipbuilding/tam/consolidated/workbook_consolidated/sheets/_taxonomy.py
(the canonical taxonomy, which the research _corpus.py also loads); this pipeline
only reads the display vocabulary (BUCKETS / UNBUCKETED) via _cuts.py. If the
canonical file changes, re-copy.
