...
The human-facing color + style rules live in deck_core/slide_guide.md; this
module is the machine-readable mirror (values kept verbatim from the locked
...
# 2. Palette
# ---------------------------------------------------------------------------
# Two roles, kept distinct (slide_guide.md -> Color):
...
# locked chrome (see slide_guide.md -> Locked chrome):
#   - BLACK is the default BODY/EXHIBIT text color (target_copy: default text is
#     BLACK 000000) and the border / Preliminary-chip-text color.
...
# flips at the third step, gray at the darkest). target_copy: default body text
# is BLACK; WHITE only on dark fills.
...
FONT = "Arial"   # Arial everywhere (slide_guide.md -> Text)
...
# ---------------------------------------------------------------------------
# 5. Chrome - locked geometry + shape ids (slide_guide.md -> Locked chrome)
# ---------------------------------------------------------------------------
